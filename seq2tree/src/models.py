...
class EncoderSeq(nn.Module):
    ...
    def forward(self, input_seqs, input_lengths, hidden=None):
        ...
        print("encoder outouts size() : ",pade_outputs.size())
        print("problem output.size( ): ",problem_output.size())
...
class Prediction(nn.Module):
    ...
    def __init__(self, hidden_size, op_nums, input_size, dropout=0.5):
        ...
        print("embeddingd table for generate_nums size : ",self.embedding_weight.size())
    ...
    def forward(self, node_stacks, left_childs, encoder_outputs, num_pades, padding_hidden, seq_mask, mask_nums):
        ...
        #generate_nums is in the front of number_embeddings
